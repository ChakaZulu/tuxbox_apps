...
{
	"bmp"                , "cdr"                , "crw"                , "gif"                , "img", "imu"     ,
	"jpeg"               , "jpg"                , "m2a"                , "m3u"                , "mp2"                ,
	"mp3"                , "mpa"                , "ogg"                , "png"                , "radiobox"           ,
	"sh"                 , "txt"                , "url"                , "wav"                , 
};
/* ATTENTION: the array file_extension_list MUST BE SORTED ASCENDING (cf. sort, man bsearch) - otherwise bsearch will not work correctly! */
...
{
	CFile::FILE_PICTURE  , CFile::FILE_CDR      , CFile::FILE_PICTURE  , CFile::FILE_PICTURE  , CFile::FILE_IMAGE, CFile::STREAM_PICTURE,
	CFile::FILE_PICTURE  , CFile::FILE_PICTURE  , CFile::FILE_MP3      , CFile::FILE_PLAYLIST , CFile::FILE_MP3      ,
	CFile::FILE_MP3      , CFile::FILE_MP3      , CFile::FILE_OGG      , CFile::FILE_PICTURE  , CFile::FILE_RADIOBOX ,
	CFile::FILE_TEXT     , CFile::FILE_TEXT     , CFile::STREAM_AUDIO  , CFile::FILE_WAV      ,
};
...
CFile::CFile( std::string _filename )
  : Size( 0 ), Mode( 0 ), Marked( false ), Time( 0 )
{
	this->Name = _filename;
