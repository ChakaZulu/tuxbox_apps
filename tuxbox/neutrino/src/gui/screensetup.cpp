		...
		switch ( msg )
		{
			...
			case CRCInput::RC_home:
				if ( ( ( g_settings.screen_StartX != x_coord[0] ) ||
    				   ...
    				   ( g_settings.screen_StartY != y_coord[0] ) ||
    				   ( g_settings.screen_EndY != y_coord[1] ) ) &&
				     ( ShowMsg("videomenu.screensetup", g_Locale->getText("messagebox.discard"), CMessageBox::mbrYes, CMessageBox::mbYes | CMessageBox::mbCancel, "", 450, -1, true) == CMessageBox::mbrCancel ) ) // UTF-8
					break;
