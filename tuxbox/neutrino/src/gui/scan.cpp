...
int CScanTs::exec(CMenuTarget* parent, string)
{
	...
	g_Zapit->startScan( g_settings.scan_astra | g_settings.scan_eutel | g_settings.scan_kopernikus | g_settings.scan_sirius | g_settings.scan_digituerk | g_settings.scan_bouquet );
