...
//				       CMenuItem* i13, CMenuItem* i14, CMenuItem* i15,
//				       CMenuItem* i16)
{
	toDisable[ 0] = i1;
	toDisable[ 1] = i2;
...
/*		   toDisable[8]->setActive(true);
		   ...
		   toDisable[14]->setActive(true);
		   toDisable[15]->setActive(true);
*/
	   }
   }
...
/*
	   ...
	   toDisable[14]->setActive(false);
	   toDisable[15]->setActive(false);
*/
   }
