...
public:
	...
	enum	{		flagNoUpDownMovement=1,		flagNoPageMovement=2,		flagShowEntryHelp=4, flagShowPartial=8, flagLostFocusOnFirst=16, flagLostFocusOnLast=32, flagHasShortcuts=64 };
