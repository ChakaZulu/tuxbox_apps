/****************************************************************************
** $Id: qsocket.h,v 1.1 2002/06/03 11:37:29 Ghostrider Exp $
**
...
class Q_EXPORT QSocket : public QObject, public QIODevice, public Object
{
    Q_OBJECT
public:
    enum Error {
...
protected:
    virtual void sn_read(int);
    virtual void sn_write(int);
