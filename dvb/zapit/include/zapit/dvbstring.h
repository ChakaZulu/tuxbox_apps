/*
 * $Header: /cvs/tuxbox/apps/dvb/zapit/include/zapit/dvbstring.h,v 1.4 2002/10/13 14:17:31 thegoodguy Exp $
 *
				...
				if ((character >= 0xA8) && (character <= 0xBA))
					...
					if ((character >= 0xC0) && (character <= 0xCF))
					{
						if (next_character != 0x00)
						{
							...
							switch ((((unsigned int) (character)) << 8) | (next_character))
							{
							case 0xC275:
								character_unicode_value = 0x00FA;
								break;
							default:
